...
# name of run.
name = 'output/equilibrium/lgm_75%ov'
...
input_zemba['occ']=np.array([-15.])    # mid-point of ocean circulation...# <--------------------- HERE
...
input_zemba['strength_of_overturning']=np.array([0.75]) # <------------------------------------------ HERE
...
# atm. co2 conc.
input_zemba['co2']=np.array([180. * (44.01/28.97) * 1e-6]) # <-------------------------------- HERE
